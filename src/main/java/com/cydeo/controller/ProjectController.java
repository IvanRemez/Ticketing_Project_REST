...
public class ProjectController {
    ...
    public ResponseEntity<ResponseWrapper> getProjectByCode(
        ...
        return ResponseEntity
                .ok(new ResponseWrapper("Project retrieved",
    ...
    public ResponseEntity<ResponseWrapper> createProject(@RequestBody ProjectDTO project) {
        ...
        return ResponseEntity
                ...
                .body(new ResponseWrapper("Project created", HttpStatus.CREATED));
    }
    ...
    public ResponseEntity<ResponseWrapper> updateProject(@RequestBody ProjectDTO project) {
        ...
        return ResponseEntity
                .ok(new ResponseWrapper("Project updated", HttpStatus.OK));
    }
    ...
    @RolesAllowed("Manager")
    @Operation(summary = "Manager - Get project")
    public ResponseEntity<ResponseWrapper> getProjectByManager() {

        return ResponseEntity
                .ok(new ResponseWrapper("Projects retrieved by assigned Manager",
    ...
    public ResponseEntity<ResponseWrapper> managerCompleteProject(
        ...
        return ResponseEntity
                .ok(new ResponseWrapper("Project completed", HttpStatus.OK));
    }
}

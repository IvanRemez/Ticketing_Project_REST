...
public class KeycloakServiceImpl implements KeycloakService {
    ...
    // ^^ captures PW from Postman and assigns it to User PW in Keycloak
    ...
    // ^^ basically acts as a MAPPER b/w UserDTO (User create form) and
        // Keycloak User creation

        Keycloak keycloak = getKeycloakInstance();
    // ^^ in order to do anything in Keycloak, we need to open an Instance
        // same as opening a Transaction in DB to modify data
        ...
        // ^^ gets User ID created by Keycloak
        ...
        // ^^ goes to Keycloak Realm and matches User Role w/ standard roles in the Realm
        // will throw error if Role doesn't exist in the Realm
    ...
    // ^^ using KeycloakProperties to pass serverURL, Realm, Master username + PW, clientID
    // from application.properties to Spring, so it can access Keycloak
}